...
function SideBar() {
	...
	return (
		<aside class={state ? "sidebar open" : "sidebar"} onMouseEnter={handleSideBar} onMouseLeave={handleSideBar}>
			<div class="top-sidebar">
				<Link href="#" class="channel-logo">
					<img
				...
				<div class="hidden-sidebar channel-name">Web Dev Simplified</div>
			</div>
